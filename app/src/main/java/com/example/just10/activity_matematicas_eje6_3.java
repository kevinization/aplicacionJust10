...
public class activity_matematicas_eje6_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_eje6_3);
        aciertos = (TextView) findViewById(R.id.mat63_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_eje6_2.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_eje6_2.acier;
    ...
    public void mat64(View view){
        Intent mat64 = new Intent(this, activity_matematicas_eje6_4.class);
        startActivity(mat64);
    }
}