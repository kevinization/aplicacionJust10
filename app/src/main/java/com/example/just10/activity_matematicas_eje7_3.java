...
public class activity_matematicas_eje7_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_eje7_3);
    ...
    public void comprobacion(View view){
        ...
        claseBD.actualizarPuntajes(idvalor,"EST", String.valueOf(acier));
