...
public class activity_matematicas_eje6_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_eje6_2);
        aciertos = (TextView) findViewById(R.id.mat62_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_eje6_1.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_eje6_1.acier;
    ...
    public void mat63(View view){
        Intent mat63 = new Intent(this, activity_matematicas_eje6_3.class);
        startActivity(mat63);
    }
}