...
public class activity_matematicas_eje6_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_eje6_9);

        aciertos = (TextView) findViewById(R.id.mat69_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_eje6_8.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_eje6_8.acier;
    ...
    public void mat610(View view){
        Intent mat610 = new Intent(this, activity_matematicas_eje6_10.class);
