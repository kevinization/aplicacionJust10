...
public class activity_matematicas_eje6_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_eje6_7);
        aciertos = (TextView) findViewById(R.id.mat67_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_eje6_6.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_eje6_6.acier;
    ...
    public void mat68(View view){
        Intent mat68 = new Intent(this, activity_matematicas_eje6_8.class);
        startActivity(mat68);
    }
}