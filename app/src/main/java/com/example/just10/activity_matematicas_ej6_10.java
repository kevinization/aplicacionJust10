...
public class activity_matematicas_ej6_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_ej6_10);

        aciertos = (TextView) findViewById(R.id.mat610_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_ej6_9.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_ej6_9.acier;
    ...
    public void mat611(View view){
        Intent mat611 = new Intent(this, activity_matematicas_ej6_11.class);
