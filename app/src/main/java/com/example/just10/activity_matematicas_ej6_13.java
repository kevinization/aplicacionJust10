...
public class activity_matematicas_ej6_13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_ej6_13);
...
public void comprobacion(View view){
    ...
    public void mat7(View view){
        Intent mat7 = new Intent(this, activity_matematicas_ej7.class);
        startActivity(mat7);
        finalizar(view);
        }
