...
public class activity_matematicas_ej6_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_ej6_5);

        aciertos = (TextView) findViewById(R.id.mat65_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_ej6_4.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_ej6_4.acier;
    ...
    public void mat66(View view){
        Intent mat66 = new Intent(this, activity_matematicas_ej6_6.class);
        startActivity(mat66);
    }
}