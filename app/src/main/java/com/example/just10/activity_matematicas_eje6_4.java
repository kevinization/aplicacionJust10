...
public class activity_matematicas_eje6_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matematicas_eje6_4);

        aciertos = (TextView) findViewById(R.id.mat64_txtAciertos);
        aciertos.setText(activity_matematicas_ej1_3.textoAciertos + activity_matematicas_eje6_3.acier);
    ...
    public void comprobacion(View view){
        ...
        acier = activity_matematicas_eje6_3.acier;
    ...
    public void mat65(View view){
        Intent mat65 = new Intent(this, activity_matematicas_eje6_5.class);
        startActivity(mat65);
    }
}